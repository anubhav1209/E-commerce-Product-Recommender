...
def get_last_user_interaction(user_id: str):
    ...
    conn = get_db_connection()
    # For simplicity, we just grab the latest interaction. A real system might be more complex.
...
def get_recommendations_for_user(user_id: str):
    ...
    # 3. For each recommendation, fetch details and generate an explanation
